...
public class NotesListActivity extends Activity implements OnClickListener, OnItemLongClickListener {
    ...
    private void openNode(NoteItemData item) {
        // 检查是否是加密笔记
        if (item.isPrivate()) {
            // 如果是加密笔记，显示密码验证对话框
            showPasswordVerifyDialog(item.getId());
        } else {
            // 非加密笔记，直接打开
            Intent intent = new Intent(this, NoteEditActivity.class);
    ...
    private void showPasswordVerifyDialog(final long noteId) {
        ...
        builder.setView(dialogView)
               ...
               .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        // 验证密码
                        WorkingNote note = WorkingNote.load(NotesListActivity.this, noteId);
                        if (note != null && note.validatePassword(password)) {
                            // 密码正确，打开笔记
